package com.lelestacia.dicodingstoryapp.ui.camera
...
import com.lelestacia.dicodingstoryapp.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun takePhoto() {
        ...
        val photoFile = Utility().createFile(application)
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                Toast.makeText(
                    this@CameraActivity,
                    resources.getString(R.string.error_launch_camera),
                    Toast.LENGTH_SHORT
                ).show()
            }
        }, ContextCompat.getMainExecutor(this))
